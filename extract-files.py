...
lib_fixups: lib_fixups_user_type = {
    **lib_fixups,
    ...
    # Remove duplicate prebuilt modules (keep main ones)
    (
        'prebuilt_vendor.qti.hardware.radio.qcrilhook@1.0',
        'prebuilt_com.qualcomm.qti.dpm.api@1.0',
        'prebuilt_com.qualcomm.qti.imscmservice@2.0',
        'prebuilt_com.qualcomm.qti.imscmservice@2.1',
        'prebuilt_com.qualcomm.qti.imscmservice@2.2',
        'prebuilt_com.qualcomm.qti.uceservice@2.0',
        'prebuilt_com.qualcomm.qti.uceservice@2.1',
        'prebuilt_vendor.display.postproc@1.0',
        'prebuilt_vendor.qti.data.mwqem@1.0',
        'prebuilt_vendor.qti.data.slm@1.0',
        'prebuilt_vendor.qti.diaghal@1.0',
        'prebuilt_vendor.qti.hardware.data.connection@1.0',
        'prebuilt_vendor.qti.hardware.data.connection@1.1',
        'prebuilt_vendor.qti.hardware.data.connectionfactory-V1-ndk',
        'prebuilt_vendor.qti.hardware.display.config-V2-ndk',
        'prebuilt_vendor.qti.hardware.display.config-V3-ndk',
        'prebuilt_vendor.qti.hardware.display.config-V4-ndk',
        'prebuilt_vendor.qti.hardware.display.config-V5-ndk',
        'prebuilt_vendor.qti.hardware.display.config-V6-ndk',
        'prebuilt_vendor.qti.hardware.display.config-V7-ndk',
        'prebuilt_vendor.qti.hardware.display.config-V8-ndk',
        'prebuilt_vendor.qti.hardware.radio.am@1.0',
        'prebuilt_vendor.qti.hardware.radio.ims@1.0',
        'prebuilt_vendor.qti.hardware.radio.ims@1.1',
        'prebuilt_vendor.qti.hardware.radio.ims@1.2',
        'prebuilt_vendor.qti.hardware.radio.ims@1.3',
        'prebuilt_vendor.qti.hardware.radio.ims@1.4',
        'prebuilt_vendor.qti.hardware.radio.ims@1.5',
        'prebuilt_vendor.qti.hardware.wigig.netperftuner@1.0',
        'prebuilt_vendor.qti.ims.callcapability@1.0',
        'prebuilt_vendor.qti.ims.callinfo@1.0',
        'prebuilt_vendor.qti.ims.rcsconfig@1.0',
        'prebuilt_vendor.qti.ims.rcsconfig@1.1',
        'prebuilt_vendor.qti.ims.rcsconfig@2.0',
        'prebuilt_vendor.qti.ims.rcsconfig@2.1',
        'prebuilt_vendor.qti.latency@2.0',
        'prebuilt_vendor.qti.latency@2.1',
        'prebuilt_vendor.qti.latency@2.2',
        'prebuilt_vendor.qti.qccvndhal_aidl-V1-ndk',
        'prebuilt_vendor.qti.qesdhal@1.0',
        'prebuilt_vendor.qti.qesdhal@1.1',
        'prebuilt_vendor.qti.qesdhal@1.2',
        'prebuilt_vendor.qti.qesdhalaidl-V2-ndk',
        'prebuilt_vendor.qti.qspmhal-V1-ndk',
        'prebuilt_vendor.xiaomi.hardware.displayfeature@1.0',
        'prebuilt_vendor.xiaomi.hardware.fingerprintextension-V1-ndk',
        'prebuilt_libSNPE',
        'libagm',
        'libagmclient',
        'libagmmixer',
